...
export default function Footer() {
  ...
  return (
    <section className="relative border w-full bg-gray-900 border-gray-700">
      <div className="text-xs text-gray-400 space-y-4 border-b border-gray-700 relative">
        <div className="max-w-7xl border-l border-r border-gray-700 py-6 relative h-full px-10 mx-auto flex flex-col sm:items-center sm:justify-between md:flex-row md:space-y-0">
          <p className="md:mb-0 mb-1">Your personal content writers.</p>
      ...
      <div className="flex md:flex-row flex-col-reverse items-stretch border-l border-r border-gray-700 justify-center h-full mx-auto max-w-7xl md:space-x-10">
        <div className="flex w-full md:w-1/2 flex-col sm:items-center justify-center space-y-5 p-10 md:pr-0 md:items-start">
          ...
          <p className="sm:text-center text-xs leading-5 text-gray-500 md:text-left">
        ...
        <div className="w-full md:w-1/2 md:pl-0 p-10 flex sm:items-center md:items-start flex-col justify-center">
          ...
          <div className="flex w-full space-x-2">
            <input
              ...
              className="block w-full rounded bg-gray-700 placeholder-gray-400 border-gray-700 border text-sm transition px-3 text-white"
            />
            <button
              type="submit"
              className="inline-flex w-auto flex-shrink-0 cursor-pointer select-none appearance-none items-center justify-center space-x-1 rounded bg-orange-400 px-3 py-2 text-sm font-medium text-white transition focus:outline-none focus:ring-2 focus:ring-orange-100"
            >
              Sign up
            </button>
          </div>
      ...
      <div className="text-xs text-gray-400 space-y-4 border-t border-gray-700">
